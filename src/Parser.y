...
if_stmt         : IF LPAREN expr RPAREN stmt ELSE stmt          { Debug("if_stmt -> IF LPAREN expr RPAREN stmt ELSE stmt"); $$ = ifstmt____IF_LPAREN_expr_RPAREN_stmt_ELSE_stmt($1, $2, $3, $4, $5, $6, $7); }
                ;

while_stmt      : WHILE LPAREN expr RPAREN stmt                 { Debug("while_stmt -> WHILE LPAREN expr RPAREN stmt");     $$ = whilestmt____WHILE_LPAREN_expr_RPAREN_stmt($1, $2, $3, $4, $5); }
                ;

compound_stmt   : BEGIN local_decls                             { Debug("compound_stmt -> BEGIN local_decls");              $<obj>$ = compoundstmt____BEGIN_localdecls($1, $2); }
                                   stmt_list END                { Debug("stmt_list end");                               $$ = compoundstmt____BEGIN_localdecls_stmtlist_END($1, $2, $3, $4, $5); }
                ;
